...
export var is = {
  ...
  ObjectLikeAs: isObjectLikeAs,
  Function: isFunction,
  FunctionAs: isFunctionAs,
  RegExp: isRegExp,
  Date: isDate,
  Blob: isBlob,
  File: isFile,
  Promise: isPromise,
  PromiseAs: isPromiseAs,
  Error: isError,
  TextEncoder: isTextEncoder,
  TextDecoder: isTextDecoder,
  URL: isURL,
  ...
  MapAs: isMapAs,
  WeakSet: isWeakSet,
  WeakSetAs: isWeakSetAs,
  WeakMap: isWeakMap,
  WeakMapAs: isWeakMapAs,
  DataView: isDataView,
  Buffer: isBuffer,
